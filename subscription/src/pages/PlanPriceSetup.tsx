          ...
          {plans.map((plan, index) => (
            <tr key={index}>
              <td className="px-6 py-4">
                <div className="flex items-center gap-2"> {plan.title}</div>
              </td>
              <td className="px-6 py-4">{formatPrice(plan.monthlyPrice)}</td>
              <td className="px-6 py-4">{formatPrice(plan.yearlyPrice)}</td>
              <td className="px-6 py-4">
                {formatPrice(plan.yearlyWithMonthlyPrice)}
              </td>
              <td className="px-6 py-4">{formatPrice(6.99)}</td>
              <td className="px-6 py-4">
                <button
                  onClick={cycleCurrency}
                  className="flex items-center gap-1 px-2 py-1 text-gray-500 hover:bg-gray-100 rounded"
                >
              ...
              <td className="px-6 py-4">
                <div className="flex flex-col gap-1">
                  {plan.features.slice(0, 2).map((feature, idx) => (
                    <div key={idx} className="flex items-center gap-1 text-[0.38rem] text-[#12A833]">
                      {feature.text}
                    </div>
                  ))}
              ...
              <td className="px-6 py-4">
                <div className="flex gap-2">
                  <button className="p-1 text-[#12A833] hover:bg-green-50 rounded">
                  <FaPen />
                  </button>
                  <button className="p-1 text-[#E02424] hover:bg-red-50 rounded">
                  <FaTrash />
                  </button>
                  <button className="p-1 text-[#12A833] underline">
                    More
                  </button>
                </div>
              </td>
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      <div className="flex justify-between items-center mb-6">
        ...
        <div className="flex gap-4">
          <button className="flex items-center gap-2 px-4 py-2 bg-[#12A833] text-white rounded-md text-base">
            <Plus size={20} />
            Add new
          </button>
          <div className="flex gap-2">
